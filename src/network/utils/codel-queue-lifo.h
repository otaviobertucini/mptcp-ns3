...
public:
   ...
   *
   */
  void SetMode (CoDelQueueLifo::Mode mode);
   ...
   */
  CoDelQueueLifo::Mode  GetMode (void);
...
private:
  ...
  std::stack<Ptr<Packet> > m_packets;
  ...
  TracedValue<uint32_t> drops_count;
  TracedValue<uint32_t> m_lastcount;
  TracedValue<uint32_t> trace_size;
  ...
  codel_time_t t_now;
  codel_time_t t_before;
  codel_time_t t_max;
  codel_time_t t_average;
  codel_time_t teta;
