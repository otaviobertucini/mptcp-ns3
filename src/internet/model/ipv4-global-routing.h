...
public:
  ...
  uint64_t GetTupleValue(const Ipv4Header &header, Ptr<const Packet> ipPayload); //MPTCP
...
private:
  ...
  Ptr<Ipv4Route> LookupGlobal (const Ipv4Header &header, Ptr<const Packet> ipPayload, Ptr<NetDevice> oif = 0); //MPTCP
